...
# DOCTAG-START-VISUALIZE-COLOR-IMAGE-IMPLEMENTATION
def display_rgb(rgb: np.ndarray, title: str = "RGB image", block: bool = True) -> None:
    ...
    # DOCTAG-END-VISUALIZE-COLOR-IMAGE-IMPLEMENTATION
...
# DOCTAG-START-VISUALIZE-DEPTH-MAP-IMPLEMENTATION
def display_depthmap(xyz: np.ndarray, block: bool = True) -> None:
    ...
    plt.title("Depth map")
    plt.show(block=block)
    # DOCTAG-END-VISUALIZE-DEPTH-MAP-IMPLEMENTATION


# DOCTAG-START-COPY-POINT-CLOUD-TO-OPEN3D
def copy_to_open3d_point_cloud(
    ...
    # DOCTAG-END-COPY-POINT-CLOUD-TO-OPEN3D


# DOCTAG-START-VISUALIZE-POINT-CLOUD
def display_open3d_point_cloud(open3d_point_cloud: o3d.geometry.PointCloud) -> None:
    ...
    visualizer.get_render_option().background_color = (0.1, 0.1, 0.1) # Dark gray background (기존: 0.2, 0.2, 0.2)
...
def display_pointcloud(xyz: np.ndarray, rgb: np.ndarray, normals: Optional[np.ndarray] = None) -> None:
    ...
    # DOCTAG-END-VISUALIZE-POINT-CLOUD


# DOCTAG-START-VISUALIZE-NORMALS-IMPLEMENTATION
def display_pointcloud_with_downsampled_normals(
    ...
    # DOCTAG-END-VISUALIZE-NORMALS-IMPLEMENTATION
